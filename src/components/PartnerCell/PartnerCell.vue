<template>
  <div class="partner-cell" :class="props.size">
    <div class="partner-cell__avatar" :class="props.type">
      <img :src="props.ceil.owner.photo" alt="Avatar" @click="$emit('open-m-matrix-partner')">
      <Reward
    ...
    <div class="partner-cell__name partner-cell__name_mt-8">{{ props.ceil.owner.fio }}</div>
