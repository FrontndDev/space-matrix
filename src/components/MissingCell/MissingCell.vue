<template>
  <div class="add-partner-cell">
    <div class="add-partner-cell__plus">
    ...
    <div class="add-partner-cell__title add-partner-cell__title_mt-8">Недоступно</div>
    <div class="add-partner-cell__subtitle">На этой матрице нет накопительных ячеек</div>
  </div>
</template>
