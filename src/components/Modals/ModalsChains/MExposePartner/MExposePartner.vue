      ...
      <div class="expose-partner__container">
        ...
        <div class="expose-partner__info">
          ...
          <div class="expose-partner__choice">
            ...
            <div v-if="isExposeTabs === 2" class="expose-partner__wait-list">
              ...
              <p>Партнер попадет в ваш лист ожидания, из которого вы сможете позже выставить в бесконечную ячейку, либо использовать в других цепочках</p>
            </div>
