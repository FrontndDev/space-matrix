<template>
  <div class="cell-information">
    <div class="cell-information__body">
      <div class="cell-information__icon">
      ...
      <div class="cell-information__content">
        <div
            ...
            v-show="item?.value"
        >
          <div class="cell-information__item-icon">
            <component :is="item?.icon"/>
          </div>
          <div class="cell-information__item-content">
            <div class="cell-information__item-title">{{ item?.title }}</div>
            <div class="cell-information__item-value" v-html="item?.value"/>
          </div>
        </div>
      </div>
    </div>
